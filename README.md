...
안정적인 대용량 트래픽 처리와 데이터 정합성을 고려한 코드 작성을 지향합니다.
<br/><br/>
...
| 기간 | 과정명 | 주요 학습 내용 |
|------|--------|---------------|
| **2025.04 -** | **학점은행제 컴퓨터공학 학사과정** | **이수 완료 과목:** 데이터베이스, 자료구조, 알고리즘, 운영체제, 네트워크,<br/>소프트웨어공학, 시스템프로그래밍, 컴퓨터구조, 컴퓨터그래픽 <br/>**이수 중인 과목:** 네트워크프로그래밍, 시스템분석설계, 데이터통신,<br/>C언어I, 인공지능, 윈도우즈프로그래밍I, 멀티미디어개론, 이산수학 |
